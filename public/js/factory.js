...
.factory('MainFactory', function($rootScope, $http){
    ...
    movie.getIMDBmovie = function(id) {
      return $http({
        method: 'JSONP', 
        url: 'http://www.myapifilms.com/imdb?idIMDB=' + id + '&format=JSONP&aka=0&business=1&seasons=1&technical=0&lang=en-us&actors=S&biography=0&trailer=1&movieTrivia=1&callback=JSON_CALLBACK'
      });
    }  
